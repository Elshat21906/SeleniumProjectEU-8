...
public class T1_Registration_Forum {
    ...
    public void registration_form_test() {
        ...
        WebElement inputGender = Driver.getDriver().findElement(By.xpath("//input[@type='radio']"));
        inputGender.click();

        //10.Enter date of birth
        WebElement enterDateOfBirth = Driver.getDriver().findElement(By .xpath("//input[@name='birthday']"));
         enterDateOfBirth.sendKeys("08/16/2000");
        ...
        //12.Select Job Title
         ...
         jobTitleDropdown.selectByIndex(faker.number().numberBetween(0,8));
